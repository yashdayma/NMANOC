...
const Index=()=>{
    return (
       ...
       < div className="index w-full h-full"> 
         
            <div className=" min-h-33 mt-4 bg-yellow-100 text-base ml-2 mr-2">
            ...
            <div className=" h-34 bg-orange-200 mt-2 bg- yellow-100 font- text-base self-auto ml-2 mr-2">
         ...
         <div className=" h-38 bg-orange-300 mt-2 font- text-lg self-auto ml-2 mr-2 ">
